<section class="bg-white p-6 rounded-lg shadow-md max-w-2xl mx-auto mt-6">
  <h2 class="text-xl font-semibold mb-4 text-gray-800">🧁 Upload New Product</h2>
  <form action="upload_product.php" method="POST" enctype="multipart/form-data" class="space-y-4">
    ...
    <!-- Price -->
    <div>
      <label class="block text-gray-700 font-medium mb-1" for="price">Price (Rs.)</label>
